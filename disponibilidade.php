...
$disponibilidade="<option value=''></option>";
while($registro=mysql_fetch_array($result_personal)){ $disponibilidade.= "<option value='".$registro['idoperario']."'>".$registro['Nome']." ".$registro['Apelido']." ".$registro['Apelido2']."</option>";}
